# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/im-oss/go-openai.svg)](https://pkg.go.dev/github.com/im-oss/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/im-oss/go-openai)](https://goreportcard.com/report/github.com/im-oss/go-openai)
...
### Installation:
```
go get github.com/im-oss/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/im-oss/go-openai"
)
...
See also: https://pkg.go.dev/github.com/im-oss/go-openai#ClientConfig
</details>
...
We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/im-oss/go-openai/graphs/contributors) and sponsors of this project:
